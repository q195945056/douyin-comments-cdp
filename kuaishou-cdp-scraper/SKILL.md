...
- Work stats scraping emulates iPhone Safari by default with a mobile viewport, touch input, and iPhone User-Agent. Comment scraping uses the normal Chrome page and does not emulate mobile.
